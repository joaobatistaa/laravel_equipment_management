       ...
       <div class="panel-body">
          <form method="post" action="editar_utilizador.php?id=<?php echo (int)$e_utilizador['id'];?>" class="clearfix">
            ...
            <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nomedeutilizador" value="<?php echo remove_junk(ucwords($e_utilizador['nomedeutilizador'])); ?>">
            </div>
            <div class="form-group">
              <label for="nivel">Permissão</label>
                <select class="form-control" name="nivel">
                  <?php foreach ($permissoes as $permissao ):?>
                   <option <?php if($permissao['permissao_nivel'] === $e_utilizador['utilizador_nivel']) echo 'selected="selected"';?> value="<?php echo $permissao['permissao_nivel'];?>"><?php echo ucwords($permissao['permissao_nome']);?></option>
                <?php endforeach;?>
                </select>
            </div>
            <div class="form-group">
